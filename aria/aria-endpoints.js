  ...
  function EndPoints(env, override) {
    ...
    if (!override.host) {
      if (env === "SF") {
        ...
        this.endpoints.core.host = "secure.prod.cph.ariasystems.net";
        this.endpoints.object.host = "secure.prod.cph.ariasystems.net";
        this.endpoints.admintools.host = "admintools.prod.cph.ariasystems.net";
      }
    } else {
      // set overridden endpoint host
      this.endpoints.core.host = override.host.core;
      this.endpoints.object.host = override.host.object;
      this.endpoints.admintools.host = override.host.admintools;
    }

    // Append output type to host url path
    this.endpoints.core.path = this.endpoints.core.path + "?output_format=" +
      this.outputFormat;
    this.endpoints.object.path = this.endpoints.object.path +
      "?output_format=" +
      this.outputFormat;
    this.endpoints.admintools.path = this.endpoints.admintools.path +
      "?output_format=" +
      this.outputFormat;
