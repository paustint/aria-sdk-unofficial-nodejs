  ...
  Aria.prototype.call = function(type, restCall, payload, callback) {
    return new Promise((resolve, reject) => {
      ...
      if (typeof payload !== "object") {
        reject({message: "Only payloads of type object are supported"});
      }
      ...
      if (debug) {
        console.log("Parameters: " + postData);
      }
      ...
      if (debug) {
        console.log("Endpoint details: " + JSON.stringify(options));
      }
      ...
      const req = https.request(options, function(res) {
        ...
        res.on("end", function() {
          ...
          /**
                     ...
                     */
          try {
            // Parse JSON data if output_format was set to JSON, otherwise return raw data
            let data;
      ...
      // Trigger request
      if (debug) {
        console.log("starting request: " + new Date());
      }
      req.write(postData);
      // Close object
      req.end();
